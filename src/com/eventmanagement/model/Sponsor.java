...
public class Sponsor implements Serializable {
    ...
    /**
     * Auto-generated id of the Sponsor.
     */
    private String id;
    ...
    /**
     * Biography of the Sponsor.
     * Included in the POST request.
     */
    private String biography;

    /**
     * LogoURL of the Sponsor.
     * Included in the POST request.
     */
	...
	public String toString() {
		return "Sponsor [id=" + id + ", name=" + name + ", description="
				+ description + ", biography=" + biography + ", logoURL="
				+ logoURL + ", links=" + links + "]";
	}
}