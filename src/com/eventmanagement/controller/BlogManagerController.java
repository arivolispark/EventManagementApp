...
public class BlogManagerController {
    ...
    @RequestMapping(value = "/blogs", method = RequestMethod.GET, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/blogs/archive/{ids}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/blogs/{id}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/blogs/insert/{name}/{description}/{priority}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
