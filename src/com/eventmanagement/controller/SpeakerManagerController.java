...
public class SpeakerManagerController {
    ...
    @RequestMapping(value = "/speakers", method = RequestMethod.GET, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/speakers/archive/{ids}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/speakers/{id}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/speakers/insert/{name}/{description}/{priority}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
