...
public class TaskManagerController {
	...
	@RequestMapping(value = "/tasks/archive/{ids}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/tasks/{id}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/tasks/insert/{name}/{description}/{priority}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
