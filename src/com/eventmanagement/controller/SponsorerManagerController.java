...
@RestController
public class SponsorerManagerController {
    TaskManagerService taskManagerService = new TaskManagerService();
    
    @RequestMapping(value = "/sponsorers", method = RequestMethod.GET, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/sponsorers/archive/{ids}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/sponsorers/{id}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/sponsorers/insert/{name}/{description}/{priority}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
