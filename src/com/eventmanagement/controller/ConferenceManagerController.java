...
public class ConferenceManagerController {
    ...
    @RequestMapping(value = "/conferences", method = RequestMethod.GET, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/conferences/archive/{ids}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/conferences/{id}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/conferences/insert/{name}/{description}/{priority}/{status}", method = RequestMethod.POST, headers = "Accept=application/json")
